...
from .helpers import fmt_prijs, listing_leeftijd, fmt_datum_kort, listing_eerste_gezien_ts
...
def create_app():
    ...
    app.jinja_env.globals["listing_eerste_gezien_ts"] = listing_eerste_gezien_ts
